...
const QUICK_ACTIONS = [
  ...
  {
    icon: <FavoriteIcon sx={{ fontSize: 28, color: '#ff3b30' }} />,
    title: 'Favorite',
    desc: 'Anunțurile tale salvate',
    path: '/profile/favorites',
    accent: '#ff3b30',
  },
  {
    icon: <PersonIcon sx={{ fontSize: 28, color: '#00bcd4' }} />,
    title: 'Editează profil',
    desc: 'Actualizează datele tale',
    path: '/profile/edit',
    accent: '#00bcd4',
  },
  {
    icon: <ShoppingBagIcon sx={{ fontSize: 28, color: '#ff9800' }} />,
  ...
  {
    icon: <StarIcon sx={{ fontSize: 28, color: '#ff3b30' }} />,
