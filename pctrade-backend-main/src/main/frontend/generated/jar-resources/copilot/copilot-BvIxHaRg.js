...
}, Ga = process.env.NODE_ENV !== "production" ? Ja : {};
function f(e) {
  for (var t = arguments.length, r = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++)
    r[n - 1] = arguments[n];
  if (process.env.NODE_ENV !== "production") {
    var i = typeof e == "string" ? e : Ga[e];
...
var gi = Object.assign, Ht = Object.getOwnPropertyDescriptor, _ = Object.defineProperty, lr = Object.prototype, Xt = [];
Object.freeze(Xt);
var Xr = {};
Object.freeze(Xr);
var Qa = typeof Proxy < "u", _a = /* @__PURE__ */ Object.toString();
function mi() {
  Qa || f(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function at(e) {
...
function D(e) {
  ...
  return typeof r == "function" && r.toString() === _a;
}
function bi(e) {
  var t = e?.constructor;
...
function eo(e) {
  ...
  return r.length ? [].concat(t, r.filter(function(n) {
    return lr.propertyIsEnumerable.call(e, n);
  })) : t;
}
var mt = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : wi ? function(e) {
...
function W(e, t) {
  return lr.hasOwnProperty.call(e, t);
}
var to = Object.getOwnPropertyDescriptors || function(t) {
  var r = {};
...
function Ct(e, t, r) {
  if (W(e, ie) || dr(e, ie, ve({}, e[ie])), process.env.NODE_ENV !== "production" && Jt(r) && !W(e[ie], t)) {
  ...
  oo(e, r, t), Jt(r) || (e[ie][t] = r);
}
function oo(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !Jt(t) && W(e[ie], r)) {
...
function Ei(e, t, r) {
  ...
  var n = new me(e);
  return t !== Fe && ms(n, t), r !== Fe && Ji(n, r), n;
}
function so(e, t) {
  return oa(e, t);
}
...
function De(e, t, r) {
  return wt(e) ? e : Array.isArray(e) ? C.array(e, {
    ...
    name: r
  }) : typeof e == "function" && !Ve(e) && !yt(e) ? bi(e) ? Je(e) : bt(r, e) : e;
}
function co(e, t, r) {
  if (e == null || tt(e) || br(e) || be(e) || Y(e))
    return e;
  if (Array.isArray(e))
    return C.array(e, {
      name: r,
...
function uo(e, t) {
  return process.env.NODE_ENV !== "production" && wt(e) && f("observable.struct should not be used with observable values"), oa(e, t) ? t : e;
}
var po = "override";
function Jt(e) {
...
function ho(e, t) {
  process.env.NODE_ENV !== "production" && ur(t, ["method", "field"]);
...
function ki(e, t, r, n, i) {
  var a, o, s, l, c, d, u;
  i === void 0 && (i = p.safeDescriptors), go(e, t, r, n);
  var v = n.value;
...
function mo(e, t, r, n) {
  ...
  if (yt(r.value))
    return 1;
  var a = Ai(e, this, t, r, !1, !1);
  return _(n, t, a), 2;
}
function bo(e, t, r, n) {
  var i, a = Ai(e, this, t, r, (i = this.options_) == null ? void 0 : i.bound);
  return e.defineProperty_(t, a, n);
}
function yo(e, t) {
  var r;
  process.env.NODE_ENV !== "production" && ur(t, ["method"]);
...
function Ai(e, t, r, n, i, a) {
  a === void 0 && (a = p.safeDescriptors), wo(e, t, r, n);
  var o = n.value;
  if (yt(o) || (o = Je(o)), i) {
    var s;
...
function Oo(e, t, r, n) {
  return ko(e, this, t, r), e.defineComputedProperty_(t, ve({}, this.options_, {
    get: r.get,
    set: r.set
  }), n);
}
function Eo(e, t) {
  process.env.NODE_ENV !== "production" && ur(t, ["getter"]);
...
function Ao(e, t, r, n) {
  var i, a;
  return Po(e, this, t, r), e.defineObservableProperty_(t, r.value, (i = (a = this.options_) == null ? void 0 : a.enhancer) != null ? i : De, n);
}
function So(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
...
var zo = "observable", Uo = "observable.ref", Lo = "observable.shallow", Mo = "observable.struct", Pi = {
  deep: !0,
  name: void 0,
...
var zr = /* @__PURE__ */ fr(zo), jo = /* @__PURE__ */ fr(Uo, {
  enhancer: pr
}), Ro = /* @__PURE__ */ fr(Lo, {
  enhancer: co
}), qo = /* @__PURE__ */ fr(Mo, {
...
function It(e) {
  return e.deep === !0 ? De : e.deep === !1 ? pr : Bo(e.defaultDecorator);
}
function Ko(e) {
  var t;
...
var Fo = {
  ...
  array: function(t, r) {
    var n = Vt(r);
    return (p.useProxies === !1 || n.proxy === !1 ? Rs : Ds)(t, It(n), n.name);
  },
  map: function(t, r) {
    var n = Vt(r);
  ...
  set: function(t, r) {
    var n = Vt(r);
    return new ta(t, It(n), n.name);
  },
  object: function(t, r, n) {
    return Me(function() {
      return Yi(p.useProxies === !1 || n?.proxy === !1 ? et({}, n) : As({}, n), t, r);
    });
  },
  ref: /* @__PURE__ */ $(jo),
  shallow: /* @__PURE__ */ $(Ro),
  deep: Di,
  struct: /* @__PURE__ */ $(qo)
}, C = /* @__PURE__ */ gi(Ni, Fo), Ti = "computed", Zo = "computed.struct", Ur = /* @__PURE__ */ Yr(Ti), Wo = /* @__PURE__ */ Yr(Zo, {
...
Object.assign(vr, Ur);
vr.struct = /* @__PURE__ */ $(Wo);
var fn, vn, Gt = 0, Ho = 1, Xo = (fn = (vn = /* @__PURE__ */ Ht(function() {
...
function Jo(e, t, r, n) {
  ...
  return Gt = u.actionId_, u;
}
function Go(e) {
  Gt !== e.actionId_ && f(30), Gt = e.parentActionId_, e.error_ !== void 0 && (p.suppressReactionErrors = !0), gr(e.prevAllowStateChanges_), ft(e.prevAllowStateReads_), q(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && z({
...
var Qo = "create", Se = /* @__PURE__ */ function(e) {
  ...
  return t.onBecomeStale_ = function() {
    ...
    else if (ji(this), Lr(this)) {
      var n = p.trackingContext;
      this.keepAlive_ && !n && (p.trackingContext = this), this.trackAndCompute() && rs(this), p.trackingContext = n;
    }
    var i = this.value_;
    if (Kt(i))
      throw i.cause;
    ...
    ), a = this.computeValue_(!0), o = i || Kt(n) || Kt(a) || !this.equals_(n, a);
    ...
    var i = hr(!1), a;
    if (n)
      a = Ii(this, this.derivation, this.scope_);
    ...
    return gr(i), this.isComputing = !1, a;
  }, t.suspend_ = function() {
...
B.diffValueMask_ = 16;
var mr = /* @__PURE__ */ Ue("ComputedValue", B), w;
(function(e) {
...
function Ii(e, t, r) {
  var n = Qr(!0);
  Ui(e), e.newObserving_ = new Array(
  ...
  return p.inBatch--, p.trackingDerivation = i, es(e), $o(e), ft(n), a;
}
function $o(e) {
...
function es(e) {
  ...
  for (r.length = i, e.newObserving_ = null, a = t.length; a--; ) {
    var l = t[a];
    l.diffValue === 0 && Li(l, e), l.diffValue = 0;
  }
  for (; i--; ) {
    var c = r[i];
    c.diffValue === 1 && (c.diffValue = 0, ts(c, e));
  }
...
}, Er = !0, p = /* @__PURE__ */ function() {
  var e = /* @__PURE__ */ Hr();
  return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (Er = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new Or().version && (Er = !1), Er ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new Or()) : (setTimeout(function() {
    f(35);
  }, 1), new Or());
}();
function ts(e, t) {
...
function Li(e, t) {
  e.observers_.delete(t), e.observers_.size === 0 && Mi(e);
}
function Mi(e) {
...
function ji(e) {
  ...
  return t !== null ? (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved && p.trackingContext && (e.isBeingObserved = !0, e.onBO())), e.isBeingObserved) : (e.observers_.size === 0 && p.inBatch > 0 && Mi(e), !1);
}
function Ri(e) {
  e.lowestObserverState_ !== w.STALE_ && (e.lowestObserverState_ = w.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === w.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== K.NONE && qi(t, e), t.onBecomeStale_()), t.dependenciesState_ = w.STALE_;
  }));
}
function rs(e) {
  e.lowestObserverState_ !== w.STALE_ && (e.lowestObserverState_ = w.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === w.POSSIBLY_STALE_ ? (t.dependenciesState_ = w.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== K.NONE && qi(t, e)) : t.dependenciesState_ === w.UP_TO_DATE_ && (e.lowestObserverState_ = w.UP_TO_DATE_);
  }));
}
function ns(e) {
...
function qi(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === K.BREAK) {
    var r = [];
    Ki(bs(e), r, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    if (!this.isDisposed) {
      ...
      var s = Ii(this, n, void 0);
      p.trackingContext = o, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && Mr(this), Kt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && z({
        time: Date.now() - a
      }), q();
    }
...
var gn = 100, as = function(t) {
  return t();
};
function Bi() {
  p.inBatch > 0 || p.isRunningReactions || as(os);
}
function os() {
...
var Qt = /* @__PURE__ */ Ue("Reaction", ee);
function P() {
...
var _r = "action", cs = "action.bound", Fi = "autoAction", ds = "autoAction.bound", Zi = "<unnamed action>", jr = /* @__PURE__ */ St(_r), us = /* @__PURE__ */ St(cs, {
  bound: !0
}), Rr = /* @__PURE__ */ St(Fi, {
  autoAction: !0
}), ps = /* @__PURE__ */ St(ds, {
...
var Ce = /* @__PURE__ */ Wi(!1);
Object.assign(Ce, jr);
var bt = /* @__PURE__ */ Wi(!0);
Object.assign(bt, Rr);
Ce.bound = /* @__PURE__ */ $(us);
bt.bound = /* @__PURE__ */ $(ps);
function Nd(e) {
  return Vi(e.name || Zi, !1, e, this, void 0);
}
function Ve(e) {
...
function $r(e, t, r) {
  ...
  var o = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Ce(o, r.onError ? vs(r.onError, t) : t), l = !r.scheduler && !r.delay, c = Xi(r), d = !0, u = !1, v, h = r.compareStructural ? Xe.structural : r.equals || Xe.default, m = new ee(o, function() {
    d || l ? O() : u || (u = !0, c(O));
...
function Qi(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = ys(e.observing_).map(Qi)), t;
}
function ys(e) {
...
_i.prototype = /* @__PURE__ */ Object.create(Error.prototype);
var kr = /* @__PURE__ */ Ci("flow"), xs = /* @__PURE__ */ Ci("flow.bound", {
  bound: !0
}), Je = /* @__PURE__ */ Object.assign(function(t, r) {
  if (At(r))
    return kr.decorate_20223_(t, r);
  if (Pe(r))
    return Ct(t, r, kr);
  ...
  var n = t, i = n.name || "<unnamed flow>", a = function() {
    var s = this, l = arguments, c = ++ws, d = Ce(i + " - runid: " + c + " - init", n).apply(s, l), u, v = void 0, h = new Promise(function(m, O) {
      var A = 0;
      u = O;
      function G(N) {
        v = void 0;
...
function Os(e, t) {
  return e ? tt(e) || !!e[g] || Gr(e) || Qt(e) || mr(e) : !1;
}
function wt(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && f("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), Os(e);
}
function Es() {
  if (process.env.NODE_ENV !== "production") {
...
function As(e, t) {
  var r, n;
  return mi(), e = et(e, t), (n = (r = e[g]).proxy_) != null ? n : r.proxy_ = new Proxy(e, Cs);
}
function M(e) {
...
var Cr = /* @__PURE__ */ Symbol("mobx-keys");
function $e(e, t, r) {
  return process.env.NODE_ENV !== "production" && (!D(e) && !D(Object.getPrototypeOf(e)) && f("'makeAutoObservable' can only be used for classes that don't have a superclass"), tt(e) && f("makeAutoObservable can only be used on objects not already made observable")), D(e) ? Yi(e, e, t, r) : (Me(function() {
    var n = et(e, r)[g];
    if (!e[Cr]) {
      var i = Object.getPrototypeOf(e), a = new Set([].concat(mt(e), mt(i)));
      a.delete("constructor"), a.delete(g), dr(i, Cr, a);
    }
    e[Cr].forEach(function(o) {
      return n.make_(
        o,
        // must pass "undefined" for { key: undefined }
        t && o in t ? t[o] : !0
...
var bn = "splice", Z = "update", Ss = 1e4, Ps = {
  get: function(t, r) {
    var n = t[g];
    return r === g ? n : r === "length" ? n.getArrayLength_() : typeof r == "string" && !isNaN(r) ? n.get_(parseInt(r)) : W(_t, r) ? _t[r] : t[r];
  },
  set: function(t, r, n) {
    var i = t[g];
  ...
  return t.dehanceValue_ = function(n) {
    ...
    n !== this.lastKnownLength_ && f(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && ia(n + i + 1);
  }, t.spliceWithArray_ = function(n, i, a) {
    var o = this;
    Q(this.atom_);
    var s = this.values_.length;
    if (n === void 0 ? n = 0 : n > s ? n = s : n < 0 && (n = Math.max(0, s + n)), arguments.length === 1 ? i = s - n : i == null ? i = 0 : i = Math.max(0, Math.min(i, s - n)), a === void 0 && (a = Xt), M(this)) {
      var l = j(this, {
        object: this.proxy_,
        type: bn,
        index: n,
...
function Ds(e, t, r, n) {
  return r === void 0 && (r = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), n === void 0 && (n = !1), mi(), Me(function() {
    var i = new en(r, t, n, !1);
    yi(i.values_, g, i);
    var a = new Proxy(i.values_, Ps);
...
x("reduceRight", $i);
function x(e, t) {
  typeof Array.prototype[e] == "function" && (_t[e] = t(e));
}
function U(e) {
  return function() {
    var t = this[g];
...
var Ns = /* @__PURE__ */ Ue("ObservableArrayAdministration", en);
function br(e) {
  return cr(e) && Ns(e[g]);
}
var Ts = {}, pe = "add", $t = "delete", ea = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var a = this;
    n === void 0 && (n = De), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + F() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[g] = Ts, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = n, this.name_ = i, k(Map) || f(18), Me(function() {
      a.keysAtom_ = Ei(process.env.NODE_ENV !== "production" ? a.name_ + ".keys()" : "ObservableMap.keys()"), a.data_ = /* @__PURE__ */ new Map(), a.hasMap_ = /* @__PURE__ */ new Map(), r && a.merge(r);
    });
  }
  var t = e.prototype;
  return t.has_ = function(n) {
    ...
    if (!a) {
      var o = a = new Se(this.has_(n), pr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Vr(n) + "?" : "ObservableMap.key?", !1);
      this.hasMap_.set(n, o), Ji(o, function() {
    ...
    return be(n) && (n = new Map(n)), ae(function() {
      D(n) ? eo(n).forEach(function(a) {
        return i.set(a, n[a]);
      }) : Array.isArray(n) ? n.forEach(function(a) {
        var o = a[0], s = a[1];
        return i.set(o, s);
      }) : Qe(n) ? ($a(n) || f(19, n), n.forEach(function(a, o) {
        return i.set(o, a);
      })) : n != null && f(20, n);
    }), this;
  }, t.clear = function() {
...
}(), be = /* @__PURE__ */ Ue("ObservableMap", ea);
function yn(e) {
...
var Is = {}, ta = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var a = this;
    n === void 0 && (n = De), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + F() : "ObservableSet"), this.name_ = void 0, this[g] = Is, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, k(Set) || f(22), this.enhancer_ = function(o, s) {
      return n(o, s, i);
    }, Me(function() {
      a.atom_ = Ei(a.name_), r && a.replace(r);
    });
  }
  var t = e.prototype;
  return t.dehanceValue_ = function(n) {
...
var xn = /* @__PURE__ */ Object.create(null), On = "remove", qr = /* @__PURE__ */ function() {
  ...
  return t.getObservablePropValue_ = function(n) {
    ...
    return i || (i = new Se(n in this.target_, pr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Vr(n) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(n, i)), i.get();
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[n], c && (this.values_.delete(n), c instanceof Se && (d = c.value_), Ri(c)), this.keysAtom_.reportChanged(), (o = this.pendingKeys_) == null || (o = o.get(n)) == null || o.set(n in this.target_), s || l) {
        var v = {
          type: On,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
function et(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && tt(e) && f("Options can't be provided for already observable objects."), W(e, g))
    return process.env.NODE_ENV !== "production" && !(aa(e) instanceof qr) && f("Cannot convert '" + er(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var n = (r = t?.name) != null ? r : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new qr(e, /* @__PURE__ */ new Map(), String(n), Ko(t));
  return dr(e, g, i), e;
}
var zs = /* @__PURE__ */ Ue("ObservableObjectAdministration", qr);
function En(e) {
  return xn[e] || (xn[e] = {
    get: function() {
...
function Cn(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !sa(t) && f("Cannot annotate '" + e.name_ + "." + r.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Jt(t) && W(e.appliedAnnotations_, r)) {
...
var Us = /* @__PURE__ */ na(0), Ls = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
var tn = /* @__PURE__ */ function(e) {
  function t(n, i, a, o) {
    ...
    return a === void 0 && (a = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), o === void 0 && (o = !1), s = e.call(this) || this, Me(function() {
      ...
      l.proxy_ = s, yi(s, g, l), n && n.length && s.spliceWithArray(0, 0, n), Ls && Object.defineProperty(s, "0", Us);
    }), s;
  }
  Oi(t, e);
  var r = t.prototype;
...
Object.entries(_t).forEach(function(e) {
  var t = e[0], r = e[1];
  t !== "concat" && dr(tn.prototype, t, r);
});
function na(e) {
  return {
    enumerable: !1,
...
function Ge(e, t) {
  if (typeof e == "object" && e !== null) {
    ...
    if (be(e)) {
      ...
      return r || f(25, t, er(e)), r;
    }
    if (tt(e)) {
      if (!t)
        return f(26);
      var n = e[g].values_.get(t);
      return n || f(27, t, er(e)), n;
    }
    if (Gr(e) || mr(e) || Qt(e))
      return e;
  } else if (k(e) && Qt(e[g]))
...
function aa(e, t) {
  if (e || f(29), Gr(e) || mr(e) || Qt(e) || be(e) || Y(e))
    return e;
  if (e[g])
    return e[g];
  f(24, e);
...
function Sn(e) {
  return br(e) ? e.slice() : Qe(e) || be(e) || ne(e) || Y(e) ? Array.from(e.entries()) : e;
}
var Pn, qs = ((Pn = Hr().Iterator) == null ? void 0 : Pn.prototype) || {};
function rn(e) {
  return e[Symbol.iterator] = Ks, Object.assign(Object.create(qs), e);
}
function Ks() {
  return this;
}
...
const Bs = Symbol.for("react.portal"), Fs = Symbol.for("react.fragment"), Zs = Symbol.for("react.strict_mode"), Ws = Symbol.for("react.profiler"), Hs = Symbol.for("react.provider"), Xs = Symbol.for("react.context"), la = Symbol.for("react.forward_ref"), Js = Symbol.for("react.suspense"), Gs = Symbol.for("react.suspense_list"), Ys = Symbol.for("react.memo"), Qs = Symbol.for("react.lazy");
function _s(e, t, r) {
  ...
  if (typeof e == "object")
    switch (e.$$typeof) {
      ...
      case Ys:
        ...
        return t !== null ? t : tr(e.type) || "Memo";
      case Qs: {
...
function Td() {
  ...
  return Array.from(document.body.querySelectorAll("*")).flatMap(tl).filter($s).filter((r) => !r.fileName.includes("frontend/generated/")).forEach((r) => e.add(r.fileName)), Array.from(e);
}
function $s(e) {
  return !!e && e.fileName;
}
...
function rl() {
  return `__reactFiber$${ca()}`;
}
function nl() {
  return `__reactContainer$${ca()}`;
}
function ca() {
...
function ut(e) {
  const t = e.type;
  return t?.$$typeof === la && !t.displayName && e.child ? ut(e.child) : tr(e.type) ?? tr(e.elementType) ?? "???";
}
function il() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((r) => r[nl()]).find((r) => r), t = Ie(e);
  return Ie(t?.child);
}
function al(e) {
  const t = [];
...
function ll(e) {
  return typeof e.type != "function" || da(e) ? !1 : !!(rr(e) || el(e));
}
function da(e) {
  if (!e)
    return !1;
...
const Nt = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), he = "copilot-", cl = "25.0.7", dl = "undefined", Vd = "attention-required", Id = "https://plugins.jetbrains.com/plugin/23758-vaadin", zd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Ud = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ld(e) {
...
function Tt(e) {
  Promise.resolve().then(() => xc).then(({ showNotification: t }) => {
    t(e);
  });
}
function ml() {
...
function bl(e) {
  return e.children && (e.children = e.children.filter(bl)), e.visible !== !1;
}
function Tn(e) {
...
const xl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, fa = (e) => {
  const t = [];
  let r = Vn(e);
  for (; r; )
    t.push(r), r = Vn(r);
...
function El(e) {
  return e instanceof Element && typeof e.getBoundingClientRect == "function" ? e.getBoundingClientRect() : kl(e);
}
function kl(e) {
...
function Pl(e, t) {
  const r = Al(e), n = r.getBoundingClientRect();
...
function Wd(e) {
  const t = va(e), r = Ol(t);
  !t.every((i) => Sl(i, r)) && t.length > 0 && t[0].scrollIntoView();
}
function va(e) {
  const t = e;
  if (!t)
  ...
  return t.children.flatMap((n) => va(n));
}
function Hd(e, t) {
  function r(n) {
...
function Nl(e) {
  ...
  !xl(document.documentElement.getBoundingClientRect(), t, r);
}
function Ln(e) {
...
function Mn(e) {
  return Tl(e) ? (e.close(), !0) : e.localName === "vaadin-popover" ? (e.opened = !1, !0) : !1;
}
...
const Re = {
  ...
  "vaadin-select": {
    ...
    open: (e) => {
      const t = e;
      ma(t, t._overlayElement), t.opened = !0;
    },
    close: (e) => {
      const t = e;
      ba(t, t._overlayElement), t.opened = !1;
    }
  },
  "vaadin-multi-select-combo-box": {
    ...
    open: (e) => Lt(e),
    close: (e) => {
      Mt(e), e.removeAttribute("focused");
    }
  },
  "vaadin-date-picker": {
    hideOnActivation: !0,
  ...
  e.addEventListener("focusout", ga, { capture: !0 }), ma(e), e.opened = !0;
}, Mt = (e) => {
  ba(e), e.removeAttribute("focused"), e.removeEventListener("focusout", ga, { capture: !0 }), e.opened = !1;
}, ma = (e, t) => {
  const r = t ?? e.$.overlay;
...
class Il {
  ...
  addRecentSwitchedUsername(t) {
    this.setRecentSwitchedUsernames(gl([t, ...this.recentSwitchedUsernames]));
  }
...
class zl {
  ...
  loadPreviewConfiguration() {
    Nt(`${he}get-preview`, {}, (t) => {
      ...
      Promise.resolve().then(() => Tc).then((r) => {
...
class Ml {
  constructor() {
    this.palette = { components: [] }, $e(this), this.initializer = new ya(), this.initializer.promise.then(() => {
      $r(
        () => JSON.stringify(this),
        () => {
...
window.Vaadin.copilot.eventbus = new Xa();
window.Vaadin.copilot.overlayManager = new Vl();
window.Vaadin.copilot._machineState = new Il();
window.Vaadin.copilot._storedProjectState = new Ml();
window.Vaadin.copilot._previewState = new zl();
window.Vaadin.copilot._sectionPanelUiState = new Ul();
window.Vaadin.copilot._earlyProjectState = new Ll();
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Bt = globalThis, nn = Bt.ShadowRoot && (Bt.ShadyCSS === void 0 || Bt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, an = Symbol(), Kn = /* @__PURE__ */ new WeakMap();
let wa = class {
  constructor(t, r, n) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Kl, defineProperty: Bl, getOwnPropertyDescriptor: Fl, getOwnPropertyNames: Zl, getOwnPropertySymbols: Wl, getPrototypeOf: Hl } = Object, yr = globalThis, Fn = yr.trustedTypes, Xl = Fn ? Fn.emptyScript : "", Jl = yr.reactiveElementPolyfillSupport, vt = (e, t) => e, Fr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Xl : null;
      break;
  ...
  return r;
} }, xa = (e, t) => !Kl(e, t), Zn = { attribute: !0, type: String, converter: Fr, reflect: !1, useDefault: !1, hasChanged: xa };
Symbol.metadata ??= Symbol("metadata"), yr.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let Be = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(vt("properties"))) {
      const r = this.properties, n = [...Zl(r), ...Wl(r)];
  ...
  createRenderRoot() {
    ...
    return ql(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
  ...
  requestUpdate(t, r, n) {
    if (t !== void 0) {
      ...
      if (n ??= i.getPropertyOptions(t), !((n.hasChanged ?? xa)(a, r) || n.useDefault && n.reflect && a === this._$Ej?.get(t) && !this.hasAttribute(i._$Eu(t, n)))) return;
      this.C(t, r, n);
    }
...
Be.elementStyles = [], Be.shadowRootOptions = { mode: "open" }, Be[vt("elementProperties")] = /* @__PURE__ */ new Map(), Be[vt("finalized")] = /* @__PURE__ */ new Map(), Jl?.({ ReactiveElement: Be }), (yr.reactiveElementVersions ??= []).push("2.1.0");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on = globalThis, sr = on.trustedTypes, Hn = sr ? sr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Oa = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, Ea = "?" + ue, Ql = `<${Ea}>`, ze = document, Ot = () => ze.createComment(""), Et = (e) => e === null || typeof e != "object" && typeof e != "function", sn = Array.isArray, _l = (e) => sn(e) || typeof e?.[Symbol.iterator] == "function", Pr = `[ 	
\f\r]`, ot = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xn = /-->/g, Jn = />/g, Oe = RegExp(`>|${Pr}(?:([^\\s"'>=/]+)(${Pr}*=${Pr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Gn = /'/g, Yn = /"/g, ka = /^(?:script|style|textarea|title)$/i, Ca = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), le = Ca(1), Yd = Ca(2), ge = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), Qn = /* @__PURE__ */ new WeakMap(), Ae = ze.createTreeWalker(ze, 129);
function Aa(e, t) {
...
const $l = (e, t) => {
  ...
  for (let s = 0; s < r; s++) {
    const l = e[s];
    let c, d, u = -1, v = 0;
    for (; v < l.length && (o.lastIndex = v, d = o.exec(l), d !== null); ) v = o.lastIndex, o === ot ? d[1] === "!--" ? o = Xn : d[1] !== void 0 ? o = Jn : d[2] !== void 0 ? (ka.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = Oe) : d[3] !== void 0 && (o = Oe) : o === Oe ? d[0] === ">" ? (o = i ?? ot, u = -1) : d[1] === void 0 ? u = -2 : (u = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? Oe : d[3] === '"' ? Yn : Gn) : o === Yn || o === Gn ? o = Oe : o === Xn || o === Jn ? o = ot : (o = Oe, i = void 0);
    const h = o === Oe && e[s + 1].startsWith("/>") ? " " : "";
    a += o === ot ? l + Ql : u >= 0 ? (n.push(c), l.slice(0, u) + Oa + l.slice(u) + ue + h) : l + ue + (u === -2 ? s : h);
  }
  return [Aa(e, a + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), n];
};
class kt {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    this.parts = [];
    let a = 0, o = 0;
    const s = t.length - 1, l = this.parts, [c, d] = $l(t, r);
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(Oa)) {
          const v = d[o++], h = i.getAttribute(u).split(ue), m = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: a, name: m[2], strings: h, ctor: m[1] === "." ? tc : m[1] === "?" ? rc : m[1] === "@" ? nc : wr }), i.removeAttribute(u);
      ...
      } else if (i.nodeType === 8) if (i.data === Ea) l.push({ type: 2, index: a });
      else {
        let u = -1;
...
let ec = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new rt(a, a.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(a, l.name, l.strings, this, t) : l.type === 6 && (c = new ic(a, this, t)), this._$AV.push(c), l = n[++s];
      }
...
class rt {
  ...
  _$AI(t, r = this) {
    t = Ye(this, t, r), Et(t) ? t === E || t == null || t === "" ? (this._$AH !== E && this._$AR(), this._$AH = E) : t !== this._$AH && t !== ge && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : _l(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: r, _$litType$: n } = t, i = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = kt.createElement(Aa(n.h, n.h[0]), this.options)), n);
    if (this._$AH?._$AD === i) this._$AH.p(r);
    else {
      const a = new ec(i, this), o = a.u(this.options);
...
const ac = { I: rt }, oc = on.litHtmlPolyfillSupport;
oc?.(kt, rt), (on.litHtmlVersions ??= []).push("3.3.0");
const sc = (e, t, r) => {
...
let ht = class extends Be {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = sc(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const lc = ln.litElementPolyfillSupport;
lc?.({ LitElement: ht });
(ln.litElementVersions ??= []).push("4.2.0");
class cc extends Yl(ht) {
}
class dc extends cc {
  constructor() {
...
function uc() {
  ke.push(import("./copilot-log-plugin-k9jQ-PoP.js")), ke.push(import("./copilot-info-plugin-C03ukXfd.js")), ke.push(import("./copilot-features-plugin-C7i9ifZr.js")), ke.push(import("./copilot-feedback-plugin-DyqC4FEM.js")), ke.push(import("./copilot-shortcuts-plugin-C9BiTUJ_.js"));
}
function pc() {
  {
    const e = `https://cdn.vaadin.com/copilot/${cl}/copilot-plugins${dl}.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
const jt = new vc(), y = window.Vaadin.copilot.eventbus;
if (!y)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const Ke = window.Vaadin.copilot.overlayManager, eu = {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Sa = { CHILD: 2, ELEMENT: 6 }, Pa = (e) => (...t) => ({ _$litDirective$: e, values: t });
class Da {
  constructor(t) {
  }
  get _$AU() {
...
class Zr extends Da {
  constructor(t) {
    if (super(t), this.it = E, t.type !== Sa.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const hc = Pa(Zr), nt = window.Vaadin.copilot._machineState;
if (!nt)
  throw new Error("Trying to use stored machine state before it was initialized");
const gc = 5e3;
let ei = 1;
function Na(e) {
  b.notifications.includes(e) && (e.dontShowAgain && e.dismissId && mc(e.dismissId), b.removeNotification(e), y.emit("notification-dismissed", e));
}
function Ta(e) {
  return nt.getDismissedNotifications().includes(e);
}
function mc(e) {
  Ta(e) || nt.addDismissedNotification(e);
}
function bc(e) {
  return !(e.dismissId && (Ta(e.dismissId) || b.notifications.find((t) => t.dismissId === e.dismissId)));
}
function yc() {
  const e = "A server restart is required";
  return dn() ? ar(le`${e} <br />${cn()}`) : ar(le`${e}`);
}
function cn() {
  return dn() ? le`<vaadin-button
      ...
      @click=${(e) => {
    const t = e.target;
    t.disabled = !0, t.innerText = "Restarting...", Oc();
  }}>
      Restart now
    </vaadin-button>` : E;
}
...
function wc(e) {
  ...
  return b.setNotifications([...b.notifications, r]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    Na(r);
  }, e.delay ?? gc), y.emit("notification-shown", e), r;
}
const xc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dismissNotification: Na,
  getRestartRequiredMessage: yc,
  renderRestartButton: cn,
  showNotification: Va
}, Symbol.toStringTag, { value: "Module" })), xr = window.Vaadin.copilot._earlyProjectState;
if (!xr)
...
const Ia = window.Vaadin.copilot._previewState;
if (!Ia)
...
const kc = (e) => {
...
}, Cc = (e, t) => e.error ? (Ac(e.error, t), !0) : !1, ti = (e, t, r) => {
  Tt({
    type: ye.ERROR,
    message: e,
    details: ar(
  ...
  i && a ? Pc(
    ...
    t,
    r
  ) : ti(e, t), Ec() && (n?.templateData && typeof n.templateData == "string" && n.templateData.startsWith("data") && (n.templateData = "<IMAGE_DATA>"), y.emit("system-info-with-callback", {
...
function Sc(e, t) {
  ...
  za(e, t.message, t.stack ?? "", void 0, r);
}
function Dr(e) {
  if (e === void 0)
    return !1;
...
${r}` : "")
  ...
  Dr(t) && t.suggestRestart && dn() && (n.details = ar(le`${e}<br />${r} ${cn()}`), n.delay = 3e4), Tt(n);
  let i;
...
function Ua() {
  ...
  if (Array.isArray(t))
    for (const r of t)
      Array.isArray(r) ? Ft.push(...r) : Ft.push(r);
  La((r) => Ft.push(r));
}
  ...
  window.Vaadin.ConsoleErrors = {
    push: (r) => {
      r[0] === null || r[0] === void 0 || (r[0].type !== void 0 && r[0].message !== void 0 ? e({
        ...
        details: r[0].details,
        link: r[0].link
      }) : e({ type: ye.ERROR, message: r.map((n) => Dc(n)).join(" "), internal: !1 }), t.push(r));
    }
  };
}
function Dc(e) {
...
const Tc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  catchErrors: La,
  consoleErrorsQueue: Ft,
  handleBrowserOperationError: Sc,
  handleCopilotError: ce,
  handleErrorDuringOperation: kc,
  handleServerOperationErrorIfNeeded: Cc,
  installErrorHandlers: Ua,
  showNotReactFlowProject: Nc
}, Symbol.toStringTag, { value: "Module" })), Ma = () => {
  Vc().then((e) => b.setUserInfo(e)).catch((e) => ce("Failed to load userInfo", e));
}, Vc = async () => Nt(`${he}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ja = Symbol.for(""), Ic = (e) => {
  if (e?.r === ja) return e?._$litStatic$;
}, Ra = (e) => ({ _$litStatic$: e, r: ja }), ni = /* @__PURE__ */ new Map(), zc = (e) => (t, ...r) => {
  const n = r.length;
  let i, a;
  const o = [], s = [];
  let l, c = 0, d = !1;
  for (; c < n; ) {
    for (l = t[c]; c < n && (a = r[c], (i = Ic(a)) !== void 0); ) l += i + t[++c], d = !0;
...
const { I: Uc } = ac, tu = (e) => e.strings === void 0, ii = () => document.createComment(""), lt = (e, t, r) => {
  ...
  return r;
}, Ee = (e, t, r = e) => (e._$AI(t, r), e), Lc = {}, Mc = (e, t = Lc) => e._$AH = t, jc = (e) => e._$AH, Nr = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const ai = (e, t, r) => {
  ...
  return n;
}, qa = Pa(class extends Da {
  constructor(e) {
    if (super(e), e.type !== Sa.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(e, t, r) {
    let n;
  ...
  update(e, [t, r, n]) {
    const i = jc(e), { values: a, keys: o } = this.dt(t, r, n);
    ...
    return this.ut = o, Mc(e, l), ge;
  }
}), Zt = /* @__PURE__ */ new Map(), Rc = (e) => {
  ...
  r && e.panelInfo?.panel && Zt.set(t, r);
}, nu = (e) => {
...
function Ka(e, t, r) {
  return oi.randomUUID && !e ? oi.randomUUID() : Wc(e);
}
const Wt = [], pt = [], iu = async (e, t, r) => {
  let n, i;
  t.reqId = Ka();
...
function Hc(e) {
  for (const t of Wt)
    if (t.handleMessage(e))
      return Wt.splice(Wt.indexOf(t), 1), !0;
...
function lu() {
  const e = xr.jdkInfo;
  return !e || Za() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
function ud() {
...
class fd {
  ...
  includeReactNode(t) {
    return ut(t) === "PreconfiguredAuthProvider" || ut(t) === "RouterProvider" ? !1 : Nn(t) || ll(t);
  }
  async includeFlowNode(t) {
    if (fl(t) || Ut(t)?.hiddenByServer)
      return !1;
    const r = Ut(t);
    return r && this.nodeUuidNodeMapFlat.has(ci(r)) ? !1 : this.isInitializedInProjectSources(t);
  }
  ...
  async addToTree(t, r) {
    ...
    const o = a ?? r, s = i ? Array.from(t.children) : al(t);
    for (const l of s)
      await this.addToTree(l, o);
    return a !== void 0;
  }
  generateNodeFromFiber(t, r) {
    const n = Nn(t) ? ir(t) : void 0, i = r?.children.length ?? 0, a = this;
    return {
      node: t,
      parent: r,
      element: n,
  ...
  generateNodeFromFlow(t, r) {
    ...
    return {
      ...
      get name() {
        return ul(n) ?? zn(n.element.localName);
      },
      get identifier() {
        return Un(t);
      },
...
const Wr = (e) => {
  if (nt.isActivationShortcut())
    if (e.key === "Shift" && !e.ctrlKey && !e.altKey && !e.metaKey)
      pi = !0;
    else if (pi && e.shiftKey && (e.key === "Control" || e.key === "Meta")) {
      if (dt++, dt === 2)
...
function bd(e) {
  const t = or(e, "vaadin-context-menu-overlay");
  if (!t)
    return !1;
  const r = t.owner;
...
const vi = (e) => {
  ...
  if (!t)
    return;
  const r = bd(t), n = t.localName === "copilot-main", i = or(t, "copilot-outline-panel") !== null;
  ...
  } else wd(e) ? (y.emit("delete-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (y.emit("duplicate-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && yd() ? (y.emit("undoRedo", { undo: !e.shiftKey }), o = !0) : fi(e) || y.emit("keyboard-event", { event: e });
...
const re = md(), qt = "⇧", uu = {
  toggleCopilot: `<kbd>${qt} + ${re} ${re}</kbd>`,
  openAiPopover: `<kbd>${qt} + Space</kbd>`,
  undo: `<kbd>${re} + Z</kbd>`,
  redo: `<kbd>${re} + ${qt} + Z</kbd>`,
  duplicate: `<kbd>${re} + D</kbd>`,
  goToSource: `<kbd>${re} + B</kbd>`,
  goToAttachSource: `<kbd>${re} + ${qt} + B</kbd>`,
...
let hi = class extends dc {
  constructor() {
    super(...arguments), this.removers = [], this.initialized = !1, this.active = !1, this.overlayListener = (e) => {
      ...
      if (!e)
        return;
      const t = or(e, "copilot-drawer-panel") ?? void 0;
      if (t)
        return t;
  ...
  async init() {
    ...
    ), We.getCopilotActivation() && pa().then(() => {
    ...
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), Ua(), this.detectAppTheme(), this.initialized = !0, pd();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    jt.activate(), li.copilotActivated(), fc(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), Ke.onCopilotActivation(), await vd(), Ia.loadPreviewConfiguration(), this.ensureTopmostPopover(), this.active = !0, nt.isActivationAnimation() && b.activatedFrom !== "restore" && this.getAllDrawers().forEach((e) => {
  ...
  deactivate() {
    ...
    }), this.closeDrawers(), jt.deactivate(), li.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), Ke.onCopilotDeactivation(), this.active = !1;
  }
  getAllDrawers() {
  ...
  render() {
    return le`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${qc()}
  ...
  renderDrawer(e) {
    return le` <copilot-drawer-panel position=${e}> ${Rc(e)} </copilot-drawer-panel>`;
  }
  /**
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Xc();
  }
